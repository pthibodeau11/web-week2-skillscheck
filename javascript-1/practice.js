...
// Check to see if x is equal to true. If it is, return true as a boolean. If x does not equal true, return false as a boolean
...
// Create a function called 'iLove' that takes in two parameters, name which will be a string  and love which will be a string of something you love. 
// Have the function take the two parameters and retrun a string that says "NAMEPARAM loves LOVEPARAM" with the appropriate parameters in the string. 
// e.g. "Bryan loves skateboarding"
...
// Create a new array inside of bigOrSmall called 'answers'. Loop over the passed in arr param. 
...
// Code Here
const doubled = myNumbers.map(function(num){return num * 2});
...
// Code Here
const filtered = myNumbers.filter(function(num){return num > 100});
...
// Code Here
const total = myNumbers.reduce(function(total, num){return total += num})
